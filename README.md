...
•	Implementation is extended (in another branch)  to return a confidence score alongside the summary. The service now returns a SummaryResult containing Summary and a nullable Confidence (0..1).
